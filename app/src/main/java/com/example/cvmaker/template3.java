...
public class template3 extends AppCompatActivity {
    ...
    TextView name1,spelization,degree,collage,master,degree2,experiance,position1,disc2,experiance2,position2,disc3,phone_txt,email_txt,hobby_txt,dob_txt,gender_txt,desc,skil1,skil2,skil3,skil4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        degree2.setText(""+MainActivity2.u_name1);
