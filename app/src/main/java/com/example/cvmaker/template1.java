...
public class template1 extends AppCompatActivity {
    ...
    TextView name_txt,spelization,disc1,experiance,education,email_txt,phone_txt,dob_txt,hobby_txt,gender_txt,desc,degree,collage,master,degree2,position1,period,disc2,position2,period2,disc3,skil1,skil2,skil3,skil4;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name_txt.setText(""+MainActivity.name1);
        ...
        period2.setText(""+MainActivity3.experiance0);
